...
class Signin extends React.Component{
  ...
  onSubmitSignIn=()=>{
    fetch('https://morning-hamlet-40775.herokuapp.com/signin',{
      method: 'post',
  ...
  <div className="measure">
    ...
    <div className="">
      <input onClick={/*()=>this.props.onRouteChange('home')*/this.onSubmitSignIn}className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Sign in"/>
    </div>
    <div className="">
